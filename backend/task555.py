...
def BaseInfo(details,case):
  pdf = canvas.Canvas(f'reports/Наряды.pdf', pagesize=A4,bottomup=1)
  width, height = A4
  widthList = width/3
  heightList = height/3
  pdf.setTitle('test')
...
#   heightList = [20]
#   heightList.append(row*12)
#   heightList.append(height-20-(row*12))
