...
def backward(old_orm, new_orm):
    ...
    return [
        # Apply default value datetime.datetime(2022, 7, 4, 23, 10, 12, 835721) to the field shipment.date,
        shipment.update({shipment.date: datetime.datetime(2022, 7, 4, 23, 10, 12, 835721)}).where(shipment.date.is_null(True)),
    ]
