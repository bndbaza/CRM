...
class Drawing(peewee.Model):
    ...
    paint = CharField(default='0', max_length=40)
    class Meta:
        table_name = "drawings"
...
def forward(old_orm, new_orm):
    storesteel = new_orm['storesteel']
    return [
        # Apply default value False to the field storesteel.shop,
        storesteel.update({storesteel.shop: False}).where(storesteel.shop.is_null(True)),
    ]
