...
def forward(old_orm, new_orm):
    shipment = new_orm['shipment']
    return [
        # Apply default value '' to the field shipment.number_car,
        shipment.update({shipment.number_car: ''}).where(shipment.number_car.is_null(True)),
        # Apply default value '' to the field shipment.driver,
        shipment.update({shipment.driver: ''}).where(shipment.driver.is_null(True)),
    ]
