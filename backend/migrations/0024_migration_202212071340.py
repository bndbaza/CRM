...
def forward(old_orm, new_orm):
    catalogsteel = new_orm['catalogsteel']
    return [
        # Apply default value False to the field catalogsteel.width,
        catalogsteel.update({catalogsteel.width: False}).where(catalogsteel.width.is_null(True)),
    ]
