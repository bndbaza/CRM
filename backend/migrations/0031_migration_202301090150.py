...
def forward(old_orm, new_orm):
    needformetal = new_orm['needformetal']
    return [
        # Apply default value 0 to the field needformetal.weight,
        needformetal.update({needformetal.weight: 0}).where(needformetal.weight.is_null(True)),
    ]
