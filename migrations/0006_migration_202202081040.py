...
def forward(old_orm, new_orm):
    assembly_detail = new_orm['assembly_detail']
    paint_detail = new_orm['paint_detail']
    return [
        # Apply default value 0 to the field assembly_detail.detail,
        assembly_detail.update({assembly_detail.detail: 0}).where(assembly_detail.detail.is_null(True)),
        # Apply default value 0 to the field paint_detail.detail,
        paint_detail.update({paint_detail.detail: 0}).where(paint_detail.detail.is_null(True)),
    ]
