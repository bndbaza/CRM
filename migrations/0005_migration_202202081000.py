...
def forward(old_orm, new_orm):
    old_basic_detail = old_orm['basic_detail']
    basic_detail = new_orm['basic_detail']
    return [
        # Convert datatype of the field basic_detail.basic: INT -> VARCHAR(20),
        basic_detail.update({basic_detail.basic: old_basic_detail.basic.cast('CHAR')}).where(old_basic_detail.basic.is_null(False)),
    ]
...
def backward(old_orm, new_orm):
    ...
    basic_detail = new_orm['basic_detail']
    return [
        # Convert datatype of the field basic_detail.basic: VARCHAR -> INT,
        basic_detail.update({basic_detail.basic: old_basic_detail.basic.cast('SIGNED')}).where(old_basic_detail.basic.is_null(False)),
    ]
