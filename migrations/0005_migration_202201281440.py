...
def forward(old_orm, new_orm):
    assemblynorm = new_orm['assemblynorm']
    return [
        # Apply default value '' to the field assemblynorm.choice,
        assemblynorm.update({assemblynorm.choice: ''}).where(assemblynorm.choice.is_null(True)),
    ]
