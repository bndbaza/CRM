...
def forward(old_orm, new_orm):
    pointpart = new_orm['pointpart']
    return [
        # Apply default value 0 to the field pointpart.turning,
        pointpart.update({pointpart.turning: 0}).where(pointpart.turning.is_null(True)),
    ]
