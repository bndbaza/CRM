            ...
            <template v-slot:default>
              ...
              <tbody>
                <tr
                  ...
                  :key="stage.id"
                >
                  <td v-if="Variant(header.text,stage) & (stage.detail == $store.state.db.search | $store.state.db.search == '')"><nuxt-link :to="'detail/'+stage.detail" large><h2 class="text-center"><font :color="stage.color">{{ stage.detail }}</font></h2></nuxt-link></td>
